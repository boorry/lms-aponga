...
## Acceptance
Inscription idempotente, pin CourseVersion, réinscription par nouvel Enrollment (jamais de réactivation de l'ancien), progression et calcul COMPLETED conformes.
